...
/*
[Mã câu hỏi (qCode): cJpPOJPu].  Một dịch vụ web được định nghĩa và mô tả trong tệp ObjectService.wsdl, được triển khai trên server tại URL http://<Exam_IP>:8080/JNPWS/ObjectService?wsdl để xử lý các bài toán với đối tượng.
 ...
 */
public class Bai_cJpPOJPu_WS_ObjectService {
    public static void main(String[] args) {
        String studentCode = "B21DCCN657";
        String qCode = "cJpPOJPu";
